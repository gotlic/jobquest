...
`,o=null,d=null,l=0;async function u(){return o||(o=await (0,t.default)()),o}async function c(){let e,t=0;try{t=r.default.statSync(a).mtimeMs}catch{}if(d&&t===l)return d;let n=await u();if(r.default.existsSync(a)){let t=r.default.readFileSync(a);e=new n.Database(t)}else e=new n.Database;return e.exec(s),r.default.writeFileSync(a,Buffer.from(e.export())),l=r.default.statSync(a).mtimeMs,d=new i(e,a)}e.s(["getDb",0,c])},16793,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),n=e.i(59756),i=e.i(61916),s=e.i(74677),o=e.i(69741),d=e.i(16795),l=e.i(87718),u=e.i(95169),c=e.i(47587),E=e.i(66012),p=e.i(70101),T=e.i(26937),N=e.i(10372),x=e.i(93695);e.i(52474);var R=e.i(220),m=e.i(89171),h=e.i(62294);let L=[{title:"Lettre type — Amélioration Continue",category_id:null,content:`Madame, Monsieur,
...
Cordialement,
[PR\xc9NOM NOM]`}];async function v(){let e=await (0,h.getDb)();if(0===e.prepare("SELECT COUNT(*) as c FROM cover_letters").get().c){let t=e.prepare("INSERT INTO cover_letters (title, content, category_id) VALUES (@title, @content, @category_id)");L.forEach(e=>t.run(e))}let t=e.prepare("SELECT * FROM cover_letters ORDER BY id").all();return m.NextResponse.json(t)}async function A(e){let t=await (0,h.getDb)(),r=await e.json(),a=t.prepare(`
    INSERT INTO cover_letters (title, content, category_id, is_default)
    VALUES (@title, @content, @category_id, @is_default)
  `).run({title:r.title,content:r.content??"",category_id:r.category_id??null,is_default:+!!r.is_default});return m.NextResponse.json(t.prepare("SELECT * FROM cover_letters WHERE id = ?").get(a.lastInsertRowid),{status:201})}e.s(["GET",0,v,"POST",0,A],29712);var f=e.i(29712);let O=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/cover-letters/route",pathname:"/api/cover-letters",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/cover-letters/route.ts",nextConfigOutput:"",userland:f,...{}}),{workAsyncStorage:I,workUnitAsyncStorage:g,serverHooks:b}=O;async function U(e,t,a){a.requestMeta&&(0,n.setRequestMeta)(e,a.requestMeta),O.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let m="/api/cover-letters/route";m=m.replace(/\/index$/,"")||"/";let h=await O.prepare(e,t,{srcPage:m,multiZoneDraftMode:!1});if(!h)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:L,deploymentId:v,params:A,nextConfig:f,parsedUrl:I,isDraftMode:g,prerenderManifest:b,routerServerContext:U,isOnDemandRevalidate:y,revalidateOnlyGenerated:_,resolvedPathname:C,clientReferenceManifest:S,serverActionsManifest:w}=h,P=(0,o.normalizeAppPath)(m),D=!!(b.dynamicRoutes[P]||b.routes[C]),X=async()=>((null==U?void 0:U.render404)?await U.render404(e,t,I,!1):t.end("This page could not be found"),null);if(D&&!g){let e=!!b.routes[C],t=b.dynamicRoutes[P];if(t&&!1===t.fallback&&!e){if(f.adapterPath)return await X();throw new x.NoFallbackError}}let q=null;!D||O.isDev||g||(q="/index"===(q=C)?"/":q);let M=!0===O.isDev||!D,F=D&&!M;w&&S&&(0,s.setManifestsSingleton)({page:m,clientReferenceManifest:S,serverActionsManifest:w});let j=e.method||"GET",k=(0,i.getTracer)(),G=k.getActiveScopeSpan(),H=!!(null==U?void 0:U.isWrappedByNextServer),B=!!(0,n.getRequestMeta)(e,"minimalMode"),K=(0,n.getRequestMeta)(e,"incrementalCache")||await O.getIncrementalCache(e,f,b,B);null==K||K.resetRequestCache(),globalThis.__incrementalCache=K;let Y={params:A,previewProps:b.preview,renderOpts:{experimental:{authInterrupts:!!f.experimental.authInterrupts},cacheComponents:!!f.cacheComponents,supportsDynamicResponse:M,incrementalCache:K,cacheLifeProfiles:f.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>O.onRequestError(e,t,a,n,U)},sharedContext:{buildId:L,deploymentId:v}},$=new d.NodeNextRequest(e),W=new d.NodeNextResponse(t),V=l.NextRequestAdapter.fromNodeNextRequest($,(0,l.signalFromNodeResponse)(t));try{let n,s=async e=>O.handle(V,Y).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=k.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==u.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${j} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),n&&n!==e&&(n.setAttribute("http.route",a),n.updateName(t))}else e.updateName(`${j} ${m}`)}),o=async n=>{var i,o;let d=async({previousCacheEntry:r})=>{try{if(!B&&y&&_&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await s(n);e.fetchMetrics=Y.renderOpts.fetchMetrics;let o=Y.renderOpts.pendingWaitUntil;o&&a.waitUntil&&(a.waitUntil(o),o=void 0);let d=Y.renderOpts.collectedTags;if(!D)return await (0,E.sendResponse)($,W,i,Y.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,p.toNodeOutgoingHttpHeaders)(i.headers);d&&(t[N.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==Y.renderOpts.collectedRevalidate&&!(Y.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&Y.renderOpts.collectedRevalidate,a=void 0===Y.renderOpts.collectedExpire||Y.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:Y.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await O.onRequestError(e,t,{routerKind:"App Router",routePath:m,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:F,isOnDemandRevalidate:y})},!1,U),t}},l=await O.handleResponse({req:e,nextConfig:f,cacheKey:q,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:b,isRoutePPREnabled:!1,isOnDemandRevalidate:y,revalidateOnlyGenerated:_,responseGenerator:d,waitUntil:a.waitUntil,isMinimalMode:B});if(!D)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(o=l.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});B||t.setHeader("x-nextjs-cache",y?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),g&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let u=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return B&&D||u.delete(N.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||u.get("Cache-Control")||u.set("Cache-Control",(0,T.getCacheControlHeader)(l.cacheControl)),await (0,E.sendResponse)($,W,new Response(l.value.body,{headers:u,status:l.value.status||200})),null};H&&G?await o(G):(n=k.getActiveScopeSpan(),await k.withPropagatedContext(e.headers,()=>k.trace(u.BaseServerSpan.handleRequest,{spanName:`${j} ${m}`,kind:i.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},o),void 0,!H))}catch(t){if(t instanceof x.NoFallbackError||await O.onRequestError(e,t,{routerKind:"App Router",routePath:P,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:F,isOnDemandRevalidate:y})},!1,U),D)throw t;return await (0,E.sendResponse)($,W,new Response(null,{status:500})),null}}e.s(["handler",0,U,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:I,workUnitAsyncStorage:g})},"routeModule",0,O,"serverHooks",0,b,"workAsyncStorage",0,I,"workUnitAsyncStorage",0,g],16793)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__1j13ftr._.js.map