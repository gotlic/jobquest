...
`;function d(e,t,a){try{let r=e.exec(`PRAGMA table_info(${t})`);if(!r[0])return!1;let s=r[0].columns.indexOf("name");return r[0].values.some(e=>e[s]===a)}catch{return!1}}function c(e,t){try{let a=e.exec(`SELECT name FROM sqlite_master WHERE type='table' AND name='${t}'`);return!!a[0]?.values?.length}catch{return!1}}let u=null,p=null,N=0;async function L(){return u||(u=await (0,t.default)()),u}async function R(){let e,t=0;try{t=a.default.statSync(o).mtimeMs}catch{}if(p&&t===N)return p;let r=await L();if(a.default.existsSync(o)){let t=a.default.readFileSync(o);e=new r.Database(t)}else e=new r.Database;e.exec(l);var s=e;s.exec("CREATE TABLE IF NOT EXISTS migrations (name TEXT PRIMARY KEY, applied_at TEXT NOT NULL DEFAULT (datetime('now')))");let n=new Set;try{let e=s.exec("SELECT name FROM migrations");e[0]?.values.forEach(e=>n.add(e[0]))}catch{}if(!n.has("spaces_v1")){for(let e of(c(s,"spaces")||s.exec(`CREATE TABLE spaces (
      ...
      `);let e=i("lic12@"),t=i("tomot123");s.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (1, 'victor', 'Victor', '${e}')`),s.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (2, 'tom', 'Tom', '${t}')`),s.exec("INSERT OR IGNORE INTO migrations (name) VALUES ('spaces_v1')")}return a.default.writeFileSync(o,Buffer.from(e.export())),N=a.default.statSync(o).mtimeMs,p=new E(e,o)}e.s(["getDb",0,R],62294)},12919,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),s=e.i(59756),n=e.i(61916),i=e.i(74677),o=e.i(69741),T=e.i(16795),E=e.i(87718),l=e.i(95169),d=e.i(47587),c=e.i(66012),u=e.i(70101),p=e.i(26937),N=e.i(10372),L=e.i(93695);e.i(52474);var R=e.i(220),A=e.i(89171),h=e.i(68105),O=e.i(62294);async function U(e){try{let{slug:t,password:a}=await e.json();if(!t||!a)return A.NextResponse.json({error:"Espace et mot de passe requis"},{status:400});let r=(await (0,O.getDb)()).prepare("SELECT * FROM spaces WHERE slug = ?").get(t);if(!r||r.password_hash!==(0,h.hashPassword)(a))return A.NextResponse.json({error:"Espace ou mot de passe incorrect"},{status:401});let s=(0,h.createSpaceToken)(r.id),n=A.NextResponse.json({ok:!0,space:{id:r.id,name:r.name,slug:r.slug}});return n.cookies.set(h.SPACE_COOKIE,s,{httpOnly:!0,sameSite:"lax",path:"/",maxAge:31536e3}),n}catch(e){return console.error("[POST /api/auth]",e),A.NextResponse.json({error:"Erreur serveur"},{status:500})}}async function _(){let e=A.NextResponse.json({ok:!0});return e.cookies.delete(h.SPACE_COOKIE),e}e.s(["DELETE",0,_,"POST",0,U],59182);var f=e.i(59182);let m=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/auth/route",pathname:"/api/auth",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/auth/route.ts",nextConfigOutput:"",userland:f,...{}}),{workAsyncStorage:I,workUnitAsyncStorage:x,serverHooks:v}=m;async function g(e,t,r){r.requestMeta&&(0,s.setRequestMeta)(e,r.requestMeta),m.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let A="/api/auth/route";A=A.replace(/\/index$/,"")||"/";let h=await m.prepare(e,t,{srcPage:A,multiZoneDraftMode:!1});if(!h)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:O,deploymentId:U,params:_,nextConfig:f,parsedUrl:I,isDraftMode:x,prerenderManifest:v,routerServerContext:g,isOnDemandRevalidate:b,revalidateOnlyGenerated:w,resolvedPathname:C,clientReferenceManifest:X,serverActionsManifest:D}=h,S=(0,o.normalizeAppPath)(A),y=!!(v.dynamicRoutes[S]||v.routes[C]),F=async()=>((null==g?void 0:g.render404)?await g.render404(e,t,I,!1):t.end("This page could not be found"),null);if(y&&!x){let e=!!v.routes[C],t=v.dynamicRoutes[S];if(t&&!1===t.fallback&&!e){if(f.adapterPath)return await F();throw new L.NoFallbackError}}let P=null;!y||m.isDev||x||(P="/index"===(P=C)?"/":P);let k=!0===m.isDev||!y,q=y&&!k;D&&X&&(0,i.setManifestsSingleton)({page:A,clientReferenceManifest:X,serverActionsManifest:D});let M=e.method||"GET",j=(0,n.getTracer)(),G=j.getActiveScopeSpan(),K=!!(null==g?void 0:g.isWrappedByNextServer),B=!!(0,s.getRequestMeta)(e,"minimalMode"),Y=(0,s.getRequestMeta)(e,"incrementalCache")||await m.getIncrementalCache(e,f,v,B);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let H={params:_,previewProps:v.preview,renderOpts:{experimental:{authInterrupts:!!f.experimental.authInterrupts},cacheComponents:!!f.cacheComponents,supportsDynamicResponse:k,incrementalCache:Y,cacheLifeProfiles:f.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r,s)=>m.onRequestError(e,t,r,s,g)},sharedContext:{buildId:O,deploymentId:U}},$=new T.NodeNextRequest(e),V=new T.NodeNextResponse(t),W=E.NextRequestAdapter.fromNodeNextRequest($,(0,E.signalFromNodeResponse)(t));try{let s,i=async e=>m.handle(W,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=j.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${M} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t),s&&s!==e&&(s.setAttribute("http.route",r),s.updateName(t))}else e.updateName(`${M} ${A}`)}),o=async s=>{var n,o;let T=async({previousCacheEntry:a})=>{try{if(!B&&b&&w&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await i(s);e.fetchMetrics=H.renderOpts.fetchMetrics;let o=H.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let T=H.renderOpts.collectedTags;if(!y)return await (0,c.sendResponse)($,V,n,H.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,u.toNodeOutgoingHttpHeaders)(n.headers);T&&(t[N.NEXT_CACHE_TAGS_HEADER]=T),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,r=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await m.onRequestError(e,t,{routerKind:"App Router",routePath:A,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:b})},!1,g),t}},E=await m.handleResponse({req:e,nextConfig:f,cacheKey:P,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:v,isRoutePPREnabled:!1,isOnDemandRevalidate:b,revalidateOnlyGenerated:w,responseGenerator:T,waitUntil:r.waitUntil,isMinimalMode:B});if(!y)return null;if((null==E||null==(n=E.value)?void 0:n.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==E||null==(o=E.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});B||t.setHeader("x-nextjs-cache",b?"REVALIDATED":E.isMiss?"MISS":E.isStale?"STALE":"HIT"),x&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let l=(0,u.fromNodeOutgoingHttpHeaders)(E.value.headers);return B&&y||l.delete(N.NEXT_CACHE_TAGS_HEADER),!E.cacheControl||t.getHeader("Cache-Control")||l.get("Cache-Control")||l.set("Cache-Control",(0,p.getCacheControlHeader)(E.cacheControl)),await (0,c.sendResponse)($,V,new Response(E.value.body,{headers:l,status:E.value.status||200})),null};K&&G?await o(G):(s=j.getActiveScopeSpan(),await j.withPropagatedContext(e.headers,()=>j.trace(l.BaseServerSpan.handleRequest,{spanName:`${M} ${A}`,kind:n.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},o),void 0,!K))}catch(t){if(t instanceof L.NoFallbackError||await m.onRequestError(e,t,{routerKind:"App Router",routePath:S,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:q,isOnDemandRevalidate:b})},!1,g),y)throw t;return await (0,c.sendResponse)($,V,new Response(null,{status:500})),null}}e.s(["handler",0,g,"patchFetch",0,function(){return(0,r.patchFetch)({workAsyncStorage:I,workUnitAsyncStorage:x})},"routeModule",0,m,"serverHooks",0,v,"workAsyncStorage",0,I,"workUnitAsyncStorage",0,x],12919)}];
