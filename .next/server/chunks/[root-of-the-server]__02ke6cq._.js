...
`;function d(e,t,a){try{let r=e.exec(`PRAGMA table_info(${t})`);if(!r[0])return!1;let s=r[0].columns.indexOf("name");return r[0].values.some(e=>e[s]===a)}catch{return!1}}function c(e,t){try{let a=e.exec(`SELECT name FROM sqlite_master WHERE type='table' AND name='${t}'`);return!!a[0]?.values?.length}catch{return!1}}let u=null,p=null,N=0;async function L(){return u||(u=await (0,t.default)()),u}async function R(){let e,t=0;try{t=a.default.statSync(o).mtimeMs}catch{}if(p&&t===N)return p;let r=await L();if(a.default.existsSync(o)){let t=a.default.readFileSync(o);e=new r.Database(t)}else e=new r.Database;e.exec(l);var s=e;s.exec("CREATE TABLE IF NOT EXISTS migrations (name TEXT PRIMARY KEY, applied_at TEXT NOT NULL DEFAULT (datetime('now')))");let n=new Set;try{let e=s.exec("SELECT name FROM migrations");e[0]?.values.forEach(e=>n.add(e[0]))}catch{}if(!n.has("spaces_v1")){for(let e of(c(s,"spaces")||s.exec(`CREATE TABLE spaces (
      ...
      `);let e=i("lic12@"),t=i("tomot123");s.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (1, 'victor', 'Victor', '${e}')`),s.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (2, 'tom', 'Tom', '${t}')`),s.exec("INSERT OR IGNORE INTO migrations (name) VALUES ('spaces_v1')")}return a.default.writeFileSync(o,Buffer.from(e.export())),N=a.default.statSync(o).mtimeMs,p=new E(e,o)}e.s(["getDb",0,R],62294)},83995,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),s=e.i(59756),n=e.i(61916),i=e.i(74677),o=e.i(69741),T=e.i(16795),E=e.i(87718),l=e.i(95169),d=e.i(47587),c=e.i(66012),u=e.i(70101),p=e.i(26937),N=e.i(10372),L=e.i(93695);e.i(52474);var R=e.i(220),A=e.i(89171),O=e.i(62294);function U(e){return parseInt(e.headers.get("x-space-id")??"1",10)||1}async function h(e){try{let t=(await (0,O.getDb)()).prepare("SELECT * FROM feed_blocklist WHERE space_id = ? ORDER BY created_at DESC").all(U(e));return A.NextResponse.json(t)}catch(e){return console.error("[blocklist GET]",e),A.NextResponse.json([],{status:500})}}async function _(e){try{let t=await e.json(),a=t?.kind,r=String(t?.label??"").trim();if("company"!==a&&"offer"!==a||!r)return A.NextResponse.json({error:"kind (company|offer) et label requis"},{status:400});let s=String(t?.value??r).toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]/g,"");if(!s)return A.NextResponse.json({error:"Valeur vide"},{status:400});let n=U(e);return(await (0,O.getDb)()).prepare("INSERT OR IGNORE INTO feed_blocklist (space_id, kind, value, label) VALUES (?, ?, ?, ?)").run(n,a,s,r),A.NextResponse.json({ok:!0})}catch(e){return console.error("[blocklist POST]",e),A.NextResponse.json({error:"Erreur serveur"},{status:500})}}async function f(e){try{let t=await e.json(),a=t?.id;if(!a)return A.NextResponse.json({error:"id requis"},{status:400});return(await (0,O.getDb)()).prepare("DELETE FROM feed_blocklist WHERE id = ? AND space_id = ?").run(a,U(e)),A.NextResponse.json({ok:!0})}catch(e){return console.error("[blocklist DELETE]",e),A.NextResponse.json({error:"Erreur serveur"},{status:500})}}e.s(["DELETE",0,f,"GET",0,h,"POST",0,_],43031);var m=e.i(43031);let I=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/blocklist/route",pathname:"/api/blocklist",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/blocklist/route.ts",nextConfigOutput:"",userland:m,...{}}),{workAsyncStorage:x,workUnitAsyncStorage:b,serverHooks:v}=I;async function g(e,t,r){r.requestMeta&&(0,s.setRequestMeta)(e,r.requestMeta),I.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let A="/api/blocklist/route";A=A.replace(/\/index$/,"")||"/";let O=await I.prepare(e,t,{srcPage:A,multiZoneDraftMode:!1});if(!O)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:U,deploymentId:h,params:_,nextConfig:f,parsedUrl:m,isDraftMode:x,prerenderManifest:b,routerServerContext:v,isOnDemandRevalidate:g,revalidateOnlyGenerated:D,resolvedPathname:w,clientReferenceManifest:X,serverActionsManifest:y}=O,C=(0,o.normalizeAppPath)(A),S=!!(b.dynamicRoutes[C]||b.routes[w]),F=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,m,!1):t.end("This page could not be found"),null);if(S&&!x){let e=!!b.routes[w],t=b.dynamicRoutes[C];if(t&&!1===t.fallback&&!e){if(f.adapterPath)return await F();throw new L.NoFallbackError}}let k=null;!S||I.isDev||x||(k="/index"===(k=w)?"/":k);let q=!0===I.isDev||!S,P=S&&!q;y&&X&&(0,i.setManifestsSingleton)({page:A,clientReferenceManifest:X,serverActionsManifest:y});let j=e.method||"GET",M=(0,n.getTracer)(),G=M.getActiveScopeSpan(),B=!!(null==v?void 0:v.isWrappedByNextServer),K=!!(0,s.getRequestMeta)(e,"minimalMode"),Y=(0,s.getRequestMeta)(e,"incrementalCache")||await I.getIncrementalCache(e,f,b,K);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let H={params:_,previewProps:b.preview,renderOpts:{experimental:{authInterrupts:!!f.experimental.authInterrupts},cacheComponents:!!f.cacheComponents,supportsDynamicResponse:q,incrementalCache:Y,cacheLifeProfiles:f.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r,s)=>I.onRequestError(e,t,r,s,v)},sharedContext:{buildId:U,deploymentId:h}},$=new T.NodeNextRequest(e),V=new T.NodeNextResponse(t),W=E.NextRequestAdapter.fromNodeNextRequest($,(0,E.signalFromNodeResponse)(t));try{let s,i=async e=>I.handle(W,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=M.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==l.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${j} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t),s&&s!==e&&(s.setAttribute("http.route",r),s.updateName(t))}else e.updateName(`${j} ${A}`)}),o=async s=>{var n,o;let T=async({previousCacheEntry:a})=>{try{if(!K&&g&&D&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await i(s);e.fetchMetrics=H.renderOpts.fetchMetrics;let o=H.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let T=H.renderOpts.collectedTags;if(!S)return await (0,c.sendResponse)($,V,n,H.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,u.toNodeOutgoingHttpHeaders)(n.headers);T&&(t[N.NEXT_CACHE_TAGS_HEADER]=T),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,r=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await I.onRequestError(e,t,{routerKind:"App Router",routePath:A,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:g})},!1,v),t}},E=await I.handleResponse({req:e,nextConfig:f,cacheKey:k,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:b,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:D,responseGenerator:T,waitUntil:r.waitUntil,isMinimalMode:K});if(!S)return null;if((null==E||null==(n=E.value)?void 0:n.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==E||null==(o=E.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",g?"REVALIDATED":E.isMiss?"MISS":E.isStale?"STALE":"HIT"),x&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let l=(0,u.fromNodeOutgoingHttpHeaders)(E.value.headers);return K&&S||l.delete(N.NEXT_CACHE_TAGS_HEADER),!E.cacheControl||t.getHeader("Cache-Control")||l.get("Cache-Control")||l.set("Cache-Control",(0,p.getCacheControlHeader)(E.cacheControl)),await (0,c.sendResponse)($,V,new Response(E.value.body,{headers:l,status:E.value.status||200})),null};B&&G?await o(G):(s=M.getActiveScopeSpan(),await M.withPropagatedContext(e.headers,()=>M.trace(l.BaseServerSpan.handleRequest,{spanName:`${j} ${A}`,kind:n.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},o),void 0,!B))}catch(t){if(t instanceof L.NoFallbackError||await I.onRequestError(e,t,{routerKind:"App Router",routePath:C,routeType:"route",revalidateReason:(0,d.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:g})},!1,v),S)throw t;return await (0,c.sendResponse)($,V,new Response(null,{status:500})),null}}e.s(["handler",0,g,"patchFetch",0,function(){return(0,r.patchFetch)({workAsyncStorage:x,workUnitAsyncStorage:b})},"routeModule",0,I,"serverHooks",0,v,"workAsyncStorage",0,x,"workUnitAsyncStorage",0,b],83995)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__02ke6cq._.js.map