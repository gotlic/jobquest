...
`,o=null,l=null,d=0;async function c(){return o||(o=await (0,t.default)()),o}async function u(){let e,t=0;try{t=a.default.statSync(r).mtimeMs}catch{}if(l&&t===d)return l;let n=await c();if(a.default.existsSync(r)){let t=a.default.readFileSync(r);e=new n.Database(t)}else e=new n.Database;return e.exec(s),a.default.writeFileSync(r,Buffer.from(e.export())),d=a.default.statSync(r).mtimeMs,l=new i(e,r)}e.s(["getDb",0,u])},69243,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),n=e.i(59756),i=e.i(61916),s=e.i(74677),o=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),u=e.i(47587),p=e.i(66012),E=e.i(70101),T=e.i(26937),N=e.i(10372),R=e.i(93695);e.i(52474);var h=e.i(220),m=e.i(89171),f=e.i(62294);let y=new Set(["de","du","des","le","la","les","un","une","et","en","the","a","an","of","for","in","at","to","and","or","h","f","hf","h/f","senior","junior","stage","alternance","cdi","cdd","freelance"]);function _(e){return new Set(e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim().split(" ").filter(e=>e.length>1&&!y.has(e)))}function b(e,t){return 0===e.size&&0===t.size?1:[...e].filter(e=>t.has(e)).length/new Set([...e,...t]).size}async function A(){let e=(await (0,f.getDb)()).prepare("SELECT * FROM jobs ORDER BY created_at DESC").all();return m.NextResponse.json(e)}async function L(e){let t=await (0,f.getDb)(),a=await e.json();if(!a._force){let e={title:a.title??"",company:a.company??"",location:a.location},r=t.prepare("SELECT * FROM jobs WHERE status != ?").all("archived").map(t=>({job:t,...function(e,t){let a=b(_(e.company),_(t.company));if(a<.5)return{isDuplicate:!1,score:0};let r=b(_(e.title),_(t.title)),n=0;e.location&&t.location&&(n=.15*b(_(e.location),_(t.location)));let i=Math.min(1,.4*a+.6*r+n);return{isDuplicate:i>=.55,score:i}}(e,t)})).filter(e=>e.isDuplicate).sort((e,t)=>t.score-e.score)[0];if(r)return m.NextResponse.json({duplicate:r.job,score:Math.round(100*r.score)},{status:409})}let r=t.prepare(`
