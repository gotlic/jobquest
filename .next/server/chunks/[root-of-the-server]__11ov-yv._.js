...
`,o=null,l=null;async function d(){return o||(l||(l=(async()=>{let e,n=await (0,t.default)();if(a.default.existsSync(r)){let t=a.default.readFileSync(r);e=new n.Database(t)}else e=new n.Database;return e.exec(s),a.default.writeFileSync(r,Buffer.from(e.export())),o=new i(e,r)})()),l)}e.s(["getDb",0,d])},69243,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),n=e.i(59756),i=e.i(61916),s=e.i(74677),o=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),u=e.i(47587),p=e.i(66012),E=e.i(70101),T=e.i(26937),N=e.i(10372),R=e.i(93695);e.i(52474);var h=e.i(220),m=e.i(89171),_=e.i(62294);async function y(){let e=(await (0,_.getDb)()).prepare("SELECT * FROM jobs ORDER BY created_at DESC").all();return m.NextResponse.json(e)}async function A(e){let t=await (0,_.getDb)(),a=await e.json(),r=t.prepare(`
  ...
  `).run({url:a.url??null,title:a.title??"",company:a.company??"",location:a.location??null,remote:a.remote??null,start_date:a.start_date??null,salary:a.salary??null,contract_type:a.contract_type??null,summary:a.summary??null,description:a.description??null,contact_name:a.contact_name??null,contact_email:a.contact_email??null,contact_linkedin:a.contact_linkedin??null,network_connection:a.network_connection??null,status:a.status??"todo",added_by:a.added_by??"Équipe",priority:a.priority??"medium",tags:JSON.stringify(a.tags??[])}),n=t.prepare("SELECT * FROM jobs WHERE id = ?").get(r.lastInsertRowid);return t.prepare(`
    ...
    VALUES (?, 'added', ?, ?)
  `).run(r.lastInsertRowid,`Offre ajout\xe9e par ${a.added_by??"Équipe"}`,a.added_by??"Équipe"),m.NextResponse.json(n,{status:201})}e.s(["GET",0,y,"POST",0,A],50909);var b=e.i(50909);let x=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/jobs/route",pathname:"/api/jobs",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/jobs/route.ts",nextConfigOutput:"",userland:b,...{}}),{workAsyncStorage:L,workUnitAsyncStorage:f,serverHooks:g}=x;async function O(e,t,r){r.requestMeta&&(0,n.setRequestMeta)(e,r.requestMeta),x.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let m="/api/jobs/route";m=m.replace(/\/index$/,"")||"/";let _=await x.prepare(e,t,{srcPage:m,multiZoneDraftMode:!1});if(!_)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:y,deploymentId:A,params:b,nextConfig:L,parsedUrl:f,isDraftMode:g,prerenderManifest:O,routerServerContext:v,isOnDemandRevalidate:w,revalidateOnlyGenerated:U,resolvedPathname:I,clientReferenceManifest:C,serverActionsManifest:S}=_,D=(0,o.normalizeAppPath)(m),X=!!(O.dynamicRoutes[D]||O.routes[I]),q=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,f,!1):t.end("This page could not be found"),null);if(X&&!g){let e=!!O.routes[I],t=O.dynamicRoutes[D];if(t&&!1===t.fallback&&!e){if(L.adapterPath)return await q();throw new R.NoFallbackError}}let j=null;!X||x.isDev||g||(j="/index"===(j=I)?"/":j);let F=!0===x.isDev||!X,P=X&&!F;S&&C&&(0,s.setManifestsSingleton)({page:m,clientReferenceManifest:C,serverActionsManifest:S});let k=e.method||"GET",M=(0,i.getTracer)(),G=M.getActiveScopeSpan(),B=!!(null==v?void 0:v.isWrappedByNextServer),H=!!(0,n.getRequestMeta)(e,"minimalMode"),K=(0,n.getRequestMeta)(e,"incrementalCache")||await x.getIncrementalCache(e,L,O,H);null==K||K.resetRequestCache(),globalThis.__incrementalCache=K;let Y={params:b,previewProps:O.preview,renderOpts:{experimental:{authInterrupts:!!L.experimental.authInterrupts},cacheComponents:!!L.cacheComponents,supportsDynamicResponse:F,incrementalCache:K,cacheLifeProfiles:L.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r,n)=>x.onRequestError(e,t,r,n,v)},sharedContext:{buildId:y,deploymentId:A}},$=new l.NodeNextRequest(e),W=new l.NodeNextResponse(t),V=d.NextRequestAdapter.fromNodeNextRequest($,(0,d.signalFromNodeResponse)(t));try{let n,s=async e=>x.handle(V,Y).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=M.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${k} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t),n&&n!==e&&(n.setAttribute("http.route",r),n.updateName(t))}else e.updateName(`${k} ${m}`)}),o=async n=>{var i,o;let l=async({previousCacheEntry:a})=>{try{if(!H&&w&&U&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await s(n);e.fetchMetrics=Y.renderOpts.fetchMetrics;let o=Y.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let l=Y.renderOpts.collectedTags;if(!X)return await (0,p.sendResponse)($,W,i,Y.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,E.toNodeOutgoingHttpHeaders)(i.headers);l&&(t[N.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==Y.renderOpts.collectedRevalidate&&!(Y.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&Y.renderOpts.collectedRevalidate,r=void 0===Y.renderOpts.collectedExpire||Y.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:Y.renderOpts.collectedExpire;return{value:{kind:h.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await x.onRequestError(e,t,{routerKind:"App Router",routePath:m,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:w})},!1,v),t}},d=await x.handleResponse({req:e,nextConfig:L,cacheKey:j,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:O,isRoutePPREnabled:!1,isOnDemandRevalidate:w,revalidateOnlyGenerated:U,responseGenerator:l,waitUntil:r.waitUntil,isMinimalMode:H});if(!X)return null;if((null==d||null==(i=d.value)?void 0:i.kind)!==h.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(o=d.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});H||t.setHeader("x-nextjs-cache",w?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),g&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,E.fromNodeOutgoingHttpHeaders)(d.value.headers);return H&&X||c.delete(N.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,T.getCacheControlHeader)(d.cacheControl)),await (0,p.sendResponse)($,W,new Response(d.value.body,{headers:c,status:d.value.status||200})),null};B&&G?await o(G):(n=M.getActiveScopeSpan(),await M.withPropagatedContext(e.headers,()=>M.trace(c.BaseServerSpan.handleRequest,{spanName:`${k} ${m}`,kind:i.SpanKind.SERVER,attributes:{"http.method":k,"http.target":e.url}},o),void 0,!B))}catch(t){if(t instanceof R.NoFallbackError||await x.onRequestError(e,t,{routerKind:"App Router",routePath:D,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:w})},!1,v),X)throw t;return await (0,p.sendResponse)($,W,new Response(null,{status:500})),null}}e.s(["handler",0,O,"patchFetch",0,function(){return(0,r.patchFetch)({workAsyncStorage:L,workUnitAsyncStorage:f})},"routeModule",0,x,"serverHooks",0,g,"workAsyncStorage",0,L,"workUnitAsyncStorage",0,f],69243)}];
