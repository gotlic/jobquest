...
`,o=null,l=null,d=0;async function c(){return o||(o=await (0,t.default)()),o}async function u(){let e,t=0;try{t=r.default.statSync(a).mtimeMs}catch{}if(l&&t===d)return l;let n=await c();if(r.default.existsSync(a)){let t=r.default.readFileSync(a);e=new n.Database(t)}else e=new n.Database;return e.exec(s),r.default.writeFileSync(a,Buffer.from(e.export())),d=r.default.statSync(a).mtimeMs,l=new i(e,a)}e.s(["getDb",0,u])},49701,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),n=e.i(59756),i=e.i(61916),s=e.i(74677),o=e.i(69741),l=e.i(16795),d=e.i(87718),c=e.i(95169),u=e.i(47587),T=e.i(66012),p=e.i(70101),E=e.i(26937),N=e.i(10372),h=e.i(93695);e.i(52474);var R=e.i(220),f=e.i(89171),m=e.i(62294);let L=new Set(["de","du","des","le","la","les","un","une","et","en","au","aux","sur","par","pour","avec","dans","ce","se","the","a","an","of","for","in","at","to","and","or","with","h","f","hf","mf","stage","alternance","cdi","cdd","freelance","vie","interim","senior","junior","confirme","debutant","ingenieur","charge","responsable","directeur","manager","consultant","technicien","assistant","chef","coordinateur","analyste","developpeur","architecte"]);function A(e){return new Set(e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim().split(" ").filter(e=>e.length>2&&!L.has(e)))}function x(e,t){return 0===e.size&&0===t.size?1:0===e.size||0===t.size?0:[...e].filter(e=>t.has(e)).length/new Set([...e,...t]).size}function b(e){try{let t=new URL(e.trim());return(t.hostname+t.pathname).toLowerCase().replace(/\/$/,"")}catch{return e.toLowerCase().trim()}}async function v(e){try{let t=await (0,m.getDb)(),r=await e.json(),a={title:r.title??"",company:r.company??"",location:r.location,url:r.url},n=t.prepare("SELECT * FROM jobs WHERE status != ?").all("archived").map(e=>({title:e.title??"",company:e.company??"",location:e.location,url:e.url,...e})).map(e=>({job:e,...function(e,t){if(e.url&&t.url&&b(e.url)===b(t.url))return{isDuplicate:!0,score:100,reason:"url"};let r=A(e.company),a=x(r,A(t.company));if(a<.8)return{isDuplicate:!1,score:Math.round(50*a),reason:"content"};let n=A(e.title),i=x(n,A(t.title));if(i<.5)return{isDuplicate:!1,score:Math.round(70*i),reason:"content"};let s=0;e.location&&t.location&&(s=.1*x(A(e.location),A(t.location)));let o=Math.min(1,.3*a+.7*i+s);return{isDuplicate:o>=.75,score:Math.round(100*o),reason:"content"}}(a,e)})).filter(e=>e.isDuplicate).sort((e,t)=>t.score-e.score)[0];if(n)return f.NextResponse.json({duplicate:n.job,score:n.score,reason:n.reason},{status:409});return f.NextResponse.json({ok:!0})}catch(e){return console.error("[check-duplicate] error:",e),f.NextResponse.json({ok:!0})}}e.s(["POST",0,v],24338);var g=e.i(24338);let w=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/jobs/check-duplicate/route",pathname:"/api/jobs/check-duplicate",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/jobs/check-duplicate/route.ts",nextConfigOutput:"",userland:g,...{}}),{workAsyncStorage:O,workUnitAsyncStorage:U,serverHooks:y}=w;async function C(e,t,a){a.requestMeta&&(0,n.setRequestMeta)(e,a.requestMeta),w.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let f="/api/jobs/check-duplicate/route";f=f.replace(/\/index$/,"")||"/";let m=await w.prepare(e,t,{srcPage:f,multiZoneDraftMode:!1});if(!m)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:L,deploymentId:A,params:x,nextConfig:b,parsedUrl:v,isDraftMode:g,prerenderManifest:O,routerServerContext:U,isOnDemandRevalidate:y,revalidateOnlyGenerated:C,resolvedPathname:I,clientReferenceManifest:_,serverActionsManifest:D}=m,S=(0,o.normalizeAppPath)(f),X=!!(O.dynamicRoutes[S]||O.routes[I]),F=async()=>((null==U?void 0:U.render404)?await U.render404(e,t,v,!1):t.end("This page could not be found"),null);if(X&&!g){let e=!!O.routes[I],t=O.dynamicRoutes[S];if(t&&!1===t.fallback&&!e){if(b.adapterPath)return await F();throw new h.NoFallbackError}}let j=null;!X||w.isDev||g||(j="/index"===(j=I)?"/":j);let q=!0===w.isDev||!X,P=X&&!q;D&&_&&(0,s.setManifestsSingleton)({page:f,clientReferenceManifest:_,serverActionsManifest:D});let M=e.method||"GET",k=(0,i.getTracer)(),G=k.getActiveScopeSpan(),H=!!(null==U?void 0:U.isWrappedByNextServer),B=!!(0,n.getRequestMeta)(e,"minimalMode"),K=(0,n.getRequestMeta)(e,"incrementalCache")||await w.getIncrementalCache(e,b,O,B);null==K||K.resetRequestCache(),globalThis.__incrementalCache=K;let Y={params:x,previewProps:O.preview,renderOpts:{experimental:{authInterrupts:!!b.experimental.authInterrupts},cacheComponents:!!b.cacheComponents,supportsDynamicResponse:q,incrementalCache:K,cacheLifeProfiles:b.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,n)=>w.onRequestError(e,t,a,n,U)},sharedContext:{buildId:L,deploymentId:A}},$=new l.NodeNextRequest(e),z=new l.NodeNextResponse(t),W=d.NextRequestAdapter.fromNodeNextRequest($,(0,d.signalFromNodeResponse)(t));try{let n,s=async e=>w.handle(W,Y).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=k.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${M} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),n&&n!==e&&(n.setAttribute("http.route",a),n.updateName(t))}else e.updateName(`${M} ${f}`)}),o=async n=>{var i,o;let l=async({previousCacheEntry:r})=>{try{if(!B&&y&&C&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await s(n);e.fetchMetrics=Y.renderOpts.fetchMetrics;let o=Y.renderOpts.pendingWaitUntil;o&&a.waitUntil&&(a.waitUntil(o),o=void 0);let l=Y.renderOpts.collectedTags;if(!X)return await (0,T.sendResponse)($,z,i,Y.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,p.toNodeOutgoingHttpHeaders)(i.headers);l&&(t[N.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==Y.renderOpts.collectedRevalidate&&!(Y.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&Y.renderOpts.collectedRevalidate,a=void 0===Y.renderOpts.collectedExpire||Y.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:Y.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await w.onRequestError(e,t,{routerKind:"App Router",routePath:f,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:y})},!1,U),t}},d=await w.handleResponse({req:e,nextConfig:b,cacheKey:j,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:O,isRoutePPREnabled:!1,isOnDemandRevalidate:y,revalidateOnlyGenerated:C,responseGenerator:l,waitUntil:a.waitUntil,isMinimalMode:B});if(!X)return null;if((null==d||null==(i=d.value)?void 0:i.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(o=d.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});B||t.setHeader("x-nextjs-cache",y?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),g&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,p.fromNodeOutgoingHttpHeaders)(d.value.headers);return B&&X||c.delete(N.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,E.getCacheControlHeader)(d.cacheControl)),await (0,T.sendResponse)($,z,new Response(d.value.body,{headers:c,status:d.value.status||200})),null};H&&G?await o(G):(n=k.getActiveScopeSpan(),await k.withPropagatedContext(e.headers,()=>k.trace(c.BaseServerSpan.handleRequest,{spanName:`${M} ${f}`,kind:i.SpanKind.SERVER,attributes:{"http.method":M,"http.target":e.url}},o),void 0,!H))}catch(t){if(t instanceof h.NoFallbackError||await w.onRequestError(e,t,{routerKind:"App Router",routePath:S,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:y})},!1,U),X)throw t;return await (0,T.sendResponse)($,z,new Response(null,{status:500})),null}}e.s(["handler",0,C,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:O,workUnitAsyncStorage:U})},"routeModule",0,w,"serverHooks",0,y,"workAsyncStorage",0,O,"workUnitAsyncStorage",0,U],49701)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__1eya4g7._.js.map