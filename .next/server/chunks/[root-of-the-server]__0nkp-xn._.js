...
`;function E(e,t,a){try{let r=e.exec(`PRAGMA table_info(${t})`);if(!r[0])return!1;let n=r[0].columns.indexOf("name");return r[0].values.some(e=>e[n]===a)}catch{return!1}}function d(e,t){try{let a=e.exec(`SELECT name FROM sqlite_master WHERE type='table' AND name='${t}'`);return!!a[0]?.values?.length}catch{return!1}}let u=null,p=null,N=0;async function L(){return u||(u=await (0,t.default)()),u}async function R(){let e,t=0;try{t=a.default.statSync(o).mtimeMs}catch{}if(p&&t===N)return p;let r=await L();if(a.default.existsSync(o)){let t=a.default.readFileSync(o);e=new r.Database(t)}else e=new r.Database;return e.exec(c),!function(e){e.exec("CREATE TABLE IF NOT EXISTS migrations (name TEXT PRIMARY KEY, applied_at TEXT NOT NULL DEFAULT (datetime('now')))");let t=new Set;try{let a=e.exec("SELECT name FROM migrations");a[0]?.values.forEach(e=>t.add(e[0]))}catch{}let a=d(e,"feed_blocklist"),r=d(e,"feed_blocklist_new");if(!a&&r)try{e.exec("ALTER TABLE feed_blocklist_new RENAME TO feed_blocklist")}catch{}if(!t.has("spaces_v1")){for(let t of(d(e,"spaces")||e.exec(`CREATE TABLE spaces (
        ...
        settings TEXT NOT NULL DEFAULT '{}',
        created_at TEXT NOT NULL DEFAULT (datetime('now'))
      )`),["jobs","cvs","cv_categories","cover_letters"]))if(d(e,t)&&!E(e,t,"space_id"))try{e.exec(`ALTER TABLE ${t} ADD COLUMN space_id INTEGER NOT NULL DEFAULT 1`)}catch{}d(e,"feed_blocklist")&&!E(e,"feed_blocklist","space_id")&&(d(e,"feed_blocklist_new")&&e.exec("DROP TABLE feed_blocklist_new"),e.exec(`CREATE TABLE feed_blocklist_new (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        space_id INTEGER NOT NULL DEFAULT 1,
        kind TEXT NOT NULL CHECK (kind IN ('company', 'offer')),
        value TEXT NOT NULL,
        ...
        SELECT 1, kind, value, label, created_at FROM feed_blocklist`),e.exec("DROP TABLE feed_blocklist"),e.exec("ALTER TABLE feed_blocklist_new RENAME TO feed_blocklist"));let t=i("lic12@"),a=i("tomot123");e.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (1, 'victor', 'Victor', '${t}')`),e.exec(`INSERT OR IGNORE INTO spaces (id, slug, name, password_hash) VALUES (2, 'tom', 'Tom', '${a}')`),e.exec("INSERT OR IGNORE INTO migrations (name) VALUES ('spaces_v1')")}}(e),a.default.writeFileSync(o,Buffer.from(e.export())),N=a.default.statSync(o).mtimeMs,p=new T(e,o)}e.s(["getDb",0,R],62294)},49701,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),n=e.i(59756),s=e.i(61916),i=e.i(74677),o=e.i(69741),l=e.i(16795),T=e.i(87718),c=e.i(95169),E=e.i(47587),d=e.i(66012),u=e.i(70101),p=e.i(26937),N=e.i(10372),L=e.i(93695);e.i(20232);var R=e.i(220),h=e.i(89171),A=e.i(62294);let f=new Set(["de","du","des","le","la","les","un","une","et","en","au","aux","sur","par","pour","avec","dans","ce","se","the","a","an","of","for","in","at","to","and","or","with","h","f","hf","mf","stage","alternance","cdi","cdd","freelance","vie","interim","senior","junior","confirme","debutant","ingenieur","charge","responsable","directeur","manager","consultant","technicien","assistant","chef","coordinateur","analyste","developpeur","architecte"]);function U(e){return new Set(e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim().split(" ").filter(e=>e.length>2&&!f.has(e)))}function O(e,t){return 0===e.size&&0===t.size?1:0===e.size||0===t.size?0:[...e].filter(e=>t.has(e)).length/new Set([...e,...t]).size}function _(e){try{let t=new URL(e.trim());return(t.hostname+t.pathname).toLowerCase().replace(/\/$/,"")}catch{return e.toLowerCase().trim()}}async function m(e){try{let t=await (0,A.getDb)(),a=await e.json(),r=parseInt(e.headers.get("x-space-id")??"1",10)||1,n={title:a.title??"",company:a.company??"",location:a.location,url:a.url},s=t.prepare("SELECT * FROM jobs WHERE status != ? AND space_id = ?").all("archived",r).map(e=>({title:e.title??"",company:e.company??"",location:e.location,url:e.url,...e})).map(e=>({job:e,...function(e,t){if(e.url&&t.url&&_(e.url)===_(t.url))return{isDuplicate:!0,score:100,reason:"url"};let a=U(e.company),r=O(a,U(t.company));if(r<.8)return{isDuplicate:!1,score:Math.round(50*r),reason:"content"};let n=U(e.title),s=O(n,U(t.title));if(s<.5)return{isDuplicate:!1,score:Math.round(70*s),reason:"content"};let i=0;e.location&&t.location&&(i=.1*O(U(e.location),U(t.location)));let o=Math.min(1,.3*r+.7*s+i);return{isDuplicate:o>=.75,score:Math.round(100*o),reason:"content"}}(n,e)})).filter(e=>e.isDuplicate).sort((e,t)=>t.score-e.score)[0];if(s)return h.NextResponse.json({duplicate:s.job,score:s.score,reason:s.reason},{status:409});return h.NextResponse.json({ok:!0})}catch(e){return console.error("[check-duplicate] error:",e),h.NextResponse.json({ok:!0})}}e.s(["POST",0,m],24338);var x=e.i(24338);let I=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/jobs/check-duplicate/route",pathname:"/api/jobs/check-duplicate",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/jobs/check-duplicate/route.ts",nextConfigOutput:"",userland:x,...{}}),{workAsyncStorage:b,workUnitAsyncStorage:w,serverHooks:g}=I;async function v(e,t,r){r.requestMeta&&(0,n.setRequestMeta)(e,r.requestMeta),I.isDev&&(0,n.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/jobs/check-duplicate/route";h=h.replace(/\/index$/,"")||"/";let A=await I.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!A)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:f,deploymentId:U,params:O,nextConfig:_,parsedUrl:m,isDraftMode:x,prerenderManifest:b,routerServerContext:w,isOnDemandRevalidate:g,revalidateOnlyGenerated:v,resolvedPathname:D,clientReferenceManifest:y,serverActionsManifest:X}=A,C=(0,o.normalizeAppPath)(h),S=!!(b.dynamicRoutes[C]||b.routes[D]),F=async()=>((null==w?void 0:w.render404)?await w.render404(e,t,m,!1):t.end("This page could not be found"),null);if(S&&!x){let e=!!b.routes[D],t=b.dynamicRoutes[C];if(t&&!1===t.fallback&&!e){if(_.adapterPath)return await F();throw new L.NoFallbackError}}let k=null;!S||I.isDev||x||(k="/index"===(k=D)?"/":k);let M=!0===I.isDev||!S,P=S&&!M;X&&y&&(0,i.setManifestsSingleton)({page:h,clientReferenceManifest:y,serverActionsManifest:X});let j=e.method||"GET",q=(0,s.getTracer)(),G=q.getActiveScopeSpan(),B=!!(null==w?void 0:w.isWrappedByNextServer),K=!!(0,n.getRequestMeta)(e,"minimalMode"),Y=(0,n.getRequestMeta)(e,"incrementalCache")||await I.getIncrementalCache(e,_,b,K);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let H={params:O,previewProps:b.preview,renderOpts:{experimental:{authInterrupts:!!_.experimental.authInterrupts},cacheComponents:!!_.cacheComponents,supportsDynamicResponse:M,incrementalCache:Y,cacheLifeProfiles:_.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r,n)=>I.onRequestError(e,t,r,n,w)},sharedContext:{buildId:f,deploymentId:U}},$=new l.NodeNextRequest(e),z=new l.NodeNextResponse(t),V=T.NextRequestAdapter.fromNodeNextRequest($,(0,T.signalFromNodeResponse)(t));try{let n,i=async e=>I.handle(V,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=q.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==c.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${j} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t),n&&n!==e&&(n.setAttribute("http.route",r),n.updateName(t))}else e.updateName(`${j} ${h}`)}),o=async n=>{var s,o;let l=async({previousCacheEntry:a})=>{try{if(!K&&g&&v&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await i(n);e.fetchMetrics=H.renderOpts.fetchMetrics;let o=H.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let l=H.renderOpts.collectedTags;if(!S)return await (0,d.sendResponse)($,z,s,H.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,u.toNodeOutgoingHttpHeaders)(s.headers);l&&(t[N.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=N.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,r=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=N.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:R.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await I.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,E.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:g})},!1,w),t}},T=await I.handleResponse({req:e,nextConfig:_,cacheKey:k,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:b,isRoutePPREnabled:!1,isOnDemandRevalidate:g,revalidateOnlyGenerated:v,responseGenerator:l,waitUntil:r.waitUntil,isMinimalMode:K});if(!S)return null;if((null==T||null==(s=T.value)?void 0:s.kind)!==R.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==T||null==(o=T.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});K||t.setHeader("x-nextjs-cache",g?"REVALIDATED":T.isMiss?"MISS":T.isStale?"STALE":"HIT"),x&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let c=(0,u.fromNodeOutgoingHttpHeaders)(T.value.headers);return K&&S||c.delete(N.NEXT_CACHE_TAGS_HEADER),!T.cacheControl||t.getHeader("Cache-Control")||c.get("Cache-Control")||c.set("Cache-Control",(0,p.getCacheControlHeader)(T.cacheControl)),await (0,d.sendResponse)($,z,new Response(T.value.body,{headers:c,status:T.value.status||200})),null};B&&G?await o(G):(n=q.getActiveScopeSpan(),await q.withPropagatedContext(e.headers,()=>q.trace(c.BaseServerSpan.handleRequest,{spanName:`${j} ${h}`,kind:s.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},o),void 0,!B))}catch(t){if(t instanceof L.NoFallbackError||await I.onRequestError(e,t,{routerKind:"App Router",routePath:C,routeType:"route",revalidateReason:(0,E.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:g})},!1,w),S)throw t;return await (0,d.sendResponse)($,z,new Response(null,{status:500})),null}}e.s(["handler",0,v,"patchFetch",0,function(){return(0,r.patchFetch)({workAsyncStorage:b,workUnitAsyncStorage:w})},"routeModule",0,I,"serverHooks",0,g,"workAsyncStorage",0,b,"workUnitAsyncStorage",0,w],49701)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0nkp-xn._.js.map